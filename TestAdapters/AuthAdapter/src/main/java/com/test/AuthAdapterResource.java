...
@Path("/resource")
public class AuthAdapterResource {
	/*
	...
	static Logger logger = Logger.getLogger(AuthAdapterResource.class.getName());
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/AuthAdapter/resource"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/AuthAdapter/resource/greet?name={name}"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/AuthAdapter/resource/{path}/"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/AuthAdapter/resource/prop"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/AuthAdapter/resource/unprotected"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/AuthAdapter/resource/protected"
	 */
